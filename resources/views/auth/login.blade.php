                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <p class="mx-5">Welcome back !!!</p>

                            <h1 class="mx-5 font-weight-bold mt-2 mb-4">Login</h1>
                        ...
                        <div class="form-group mx-5 mb-0">
                            <div class="text-center">
                                <button type="submit" class="btn btn-lg btn-primary">LOGIN <svg width="20px" height="20px" viewBox="0 -5 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <p class="text-center mt-2">I don't have an account? <a href="{{ route('register') }}">Register</a></p>
                    </form>
                </div>
            </div>
        </div>
